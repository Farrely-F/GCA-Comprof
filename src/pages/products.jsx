...
function Products() {
  const [selectedCategory, setSelectedCategory] = useState("janitorial"); // Default to "janitorial"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 mx-auto place-items-center">
        {filteredProducts.map((product, index) => (
          <div
            ...
            className="hover:cursor-pointer scale-75 lg:min-h-[479px] min-w-[321px] aspect-auto shadow-[0px_4px_56px_0px_rgba(0,_0,_0,_0.15)] p-4 rounded-2xl"
          >
      ...
      <div>
        <dialog id="my_modal_2" className="modal">
          <form method="dialog" className="modal-box lg:min-w-[1/2] min-h-[90%] relative">
            {selectedProduct && (
              <>
                <img src={selectedProduct.image} alt="image" className="w-[100%] max-h-[250px] rounded-lg object-contain mb-2" />
                <div className="text-blue-700">
